...
SECRET_KEY = 'django-insecure-epic03-task04-dev-key-change-in-prod'
...
# Channels - InMemory for EPIC 03 Task 4 (Production lo Redis vadali)
CHANNEL_LAYERS = {
    "default": {
